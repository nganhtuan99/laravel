                ...
                <table id="table-cau-hoi" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <a href="{{route('nguoi-choi.cap-nhat',['id'=>$nguoiChoi->id])}}" class="btn btn-success waves-effect waves-light btn-info btn-xs" ><i class="mdi md-grease-pencil"> Sửa</i></a>
                                <a href="{{route('nguoi-choi.xoa',['id'=>$nguoiChoi->id])}}" class="btn btn-danger waves-effect waves-light btn-info btn-xs" ><i class="mdi md-trash-can-outline">Xóa</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
