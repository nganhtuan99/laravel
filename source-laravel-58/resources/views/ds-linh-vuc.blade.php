...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Danh sách Linh Vuc</h4>
                ...
                <table id="table-cau-hoi" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('linh-vuc.cap-nhat',['id'=>$linhVuc->id])}}" class="btn btn-success waves-effect waves-light btn-info btn-xs"><i class="mdi md-grease-pencil"> Sửa</i></a>
                                <a href="{{route('linh-vuc.xoa',['id'=>$linhVuc->id])}}" class="btn btn-danger waves-effect waves-light btn-info btn-xs"  ><i class="mdi md-trash-can-outline"id="sa-warning">Xóa</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
