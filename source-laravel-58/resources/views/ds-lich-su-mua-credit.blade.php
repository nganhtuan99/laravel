                ...
                <table id="table-cau-hoi" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $lichSuMuaCredit->goiCredit->credit}}</td>
                            <td>{{ $lichSuMuaCredit->goiCredit->so_tien }}</td>
                            
                            <td>  <a href="{{route('lich-su-mua-credit.xoa',['id'=>$lichSuMuaCredit->id])}}" class="btn btn-danger waves-effect waves-light btn-info btn-xs"  ><i class="mdi md-trash-can-outline"id="sa-warning">Xóa</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
