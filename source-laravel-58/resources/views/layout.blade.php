                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="pro-user-name ml-1">
                                    NA.Tuấn <i class="mdi mdi-chevron-down"></i> 
                                </span>
                            </a>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="{{route('nguoi-choi.them-moi')}}">Thêm</a>
                                    </li>
                                    <li>
                            ...
                            <li class="has-submenu">
                                <a href="{{route('linh-vuc.danh-sach')}}"> <i class="la la-clone"></i>Lĩnh Vực <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li>
                                        <a href="{{route('linh-vuc.them-moi')}}">Thêm</a>
                                    </li>
                                    <li>
                            ...
                            <li class="has-submenu">
                                <a href="{{route('lich-su-mua-credit.danh-sach')}}"> <i class="la la-briefcase"></i>Lịch sử mua Cr <div class="arrow-down"></div></a>
                                <ul class="submenu megamenu">
                                    <li>
                                        <ul>
                                            <li>
                                                <a href="{{route('lich-su-mua-credit.them-moi')}}">thêm</a>
                                            </li>
                                            <li>
                            ...
                            <li class="has-submenu">
                                <a href="{{route('luot-choi.danh-sach')}}">
                                    <i class="la la-diamond"></i>CT_Lượt chơi <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li class="has-submenu">
                                        <a href="{{route('luot-choi.them-moi')}}"><i class="fe-bookmark mr-1"></i>thêm <div class="arrow-down"></div></a>
                                        <ul class="submenu">
                                            <li>
                            ...
                            <li class="has-submenu">
                                <a href="{{route('goi-credit.danh-sach')}}"> <i class="la la-flask"></i>Credit <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li>
                                        <a href="{{route('goi-credit.them-moi')}}">thêm</a>
                                    </li>
                                    <li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu megamenu">
                                    <li>
                                        <ul>
                                            <li>
                                                <a href="{{route('apilv')}}">Lĩnh Vực</a>
                                            </li>
                                            <li>
                                                <a href="{{route('apich')}}">Câu Hỏi</a>
                                            </li>
                                            <li>
                                                <a href="{{route('apinc')}}">Người Chơi</a>
                                            </li>
                                            <li>
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="user-box">
                    ...
                    <h5><a href="javascript: void(0);">Tuấn Nguyễn</a> </h5>
