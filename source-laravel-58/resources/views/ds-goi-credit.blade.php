...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Danh sách cd</h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $goiCredit->so_tien }}</td>
                                     ...
                                     <td>
                                <a href="{{route('goi-credit.cap-nhat',['id'=>$goiCredit->id])}}" class="btn btn-success waves-effect waves-light btn-info btn-xs" ><i class="mdi md-grease-pencil"> Sửa</i></a>
                                <a href="{{route('goi-credit.xoa',['id'=>$goiCredit->id])}}" class="btn btn-danger waves-effect waves-light btn-info btn-xs" ><i class="mdi md-trash-can-outline">Xóa</i></a>
